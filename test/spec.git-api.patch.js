...
var testPatch = function(req, testDir, testFileName, contentsToPatch, files) {
  ...
  return common.post(req, '/testing/createfile', { file: path.join(testDir, testFileName), content: contentsToPatch[0] })
    .then(common.post.bind(null, req, '/commit', { path: testDir, message: 'a commit for ' + testFileName, files: [{ name: testFileName }] }))
    .then(common.post.bind(null, req, '/testing/changefile', { file: path.join(testDir, testFileName), content: contentsToPatch[1] }))
    .then(common.post.bind(null, req, '/commit', { path: testDir, message: 'patched commit ' + testFileName, files: files }));
}
...
describe('git-api: test patch api', function () {
  ...
  it('init test dir should work', function(done) {
    common.post(req, '/init', { path: testDir, bare: false })
      .then(function() { done(); }).catch(done);
  });
  ...
  it('10 lines, 10 edit, 0~2 selected', function(done) {
    var testFileName = md5(Date.now());
    var testFileSize = 10;
  ...
  it('10 lines, 10 edit, 18~19 selected', function(done) {
    var testFileName = md5(Date.now());
    var testFileSize = 10;
  ...
  it('10 lines, 10 edit, 0~2 and 18~19 selected', function(done) {
    var testFileName = md5(Date.now());
    var testFileSize = 10;
  ...
  it('10 lines, 10 edit, 5~7 selected', function(done) {
    var testFileName = md5(Date.now());
    var testFileSize = 10;
  ...
  it('30 lines, 30 edit, 0~2 and 28 ~ 29 selected', function(done) {
    var testFileName = md5(Date.now());
    var testFileSize = 30;
  ...
  it('30 lines, 30 edit, 0~2, 28~29, 58~59 selected', function(done) {
    var testFileName = md5(Date.now());
    var testFileSize = 30;
  ...
  it('30 lines, 30 edit, 6~8, 16~18 and 58 selected', function(done) {
    var testFileName = md5(Date.now());
    var testFileSize = 30;
  ...
  it('30 lines, 30 edit, 12~15 and 17~19 selected', function(done) {
    var testFileName = md5(Date.now());
    var testFileSize = 30;
  ...
  it('30 lines, 12~19 edit, 0~7, 10~16 selected ', function(done) {
    var testFileName = md5(Date.now());
    var testFileSize = 30;
  ...
  it('30 lines, 2~4, 12~14, 22~24 edit, all selected', function(done) {
    var testFileName = md5(Date.now());
    var testFileSize = 30;
  ...
  it('30 lines, 2~4, 12~14, 22~24 edit, 0~5, 12~17 selected', function(done) {
    var testFileName = md5(Date.now());
    var testFileSize = 30;
    var linesToChange = [2, 3, 4, 12, 13, 14, 22, 23, 24];
    var contentsToPatch = getContentsToPatch(testFileSize, linesToChange);
  ...
  it('30 lines, 2~4, 12~14, 22~24 edit, 6~11 selected', function(done) {
    var testFileName = md5(Date.now());
    var testFileSize = 30;
    var linesToChange = [2, 3, 4, 12, 13, 14, 22, 23, 24];
    var contentsToPatch = getContentsToPatch(testFileSize, linesToChange);
  ...
  it('30 lines, 2~4, 12~14, 22~24 edit, none selected', function(done) {
    var testFileName = md5(Date.now());
    var testFileSize = 30;
    var linesToChange = [2, 3, 4, 12, 13, 14, 22, 23, 24];
    var contentsToPatch = getContentsToPatch(testFileSize, linesToChange);
  ...
  it('30 lines, 12~14, 16~18 edit, 6~11 selected', function(done) {
    var testFileName = md5(Date.now());
    var testFileSize = 30;
  ...
  it('10 lines, add 5 lines, select 0~1, 5', function(done) {
    var testFileName = md5(Date.now());
    var testFileSize = 10;
    var linesToAdd = 5;
  ...
  it('10 lines, delete 5 lines, select 0~1, 5', function(done) {
    var testFileName = md5(Date.now());
    var testFileSize = 10;
    var linesToDelete = 5;
