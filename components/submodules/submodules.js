...
SubmdoulesViewModel.prototype.clickFetch = function() { this.fetch({ nodes: true, tags: true }); }
SubmdoulesViewModel.prototype.onProgramEvent = function(event) {
...
SubmdoulesViewModel.prototype.fetch = function(options) {
...
SubmdoulesViewModel.prototype.updateRemotes = function() {
  var self = this;
...
SubmdoulesViewModel.prototype.showAddRemoteDialog = function() {
  var self = this;
