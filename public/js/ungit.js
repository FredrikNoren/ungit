...
})(jQuery);;// https://developers.google.com/mobile/articles/fast_buttons?hl=de-DE
google = {};
google.ui = {};
google.clickbuster = {};
...
google.clickbuster.coordinates = [];;;(function(){
...
Request.prototype.end = function(fn){
  ...
  // body
  if ('HEAD' != this.method && 'string' != typeof data && !isHost(data)) {
    // serialize stuff
