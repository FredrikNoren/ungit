...
.describe('repos', 'An array of path of repos that prepend in home screen repos list')
...
.describe('dev', 'Used for development purposes. Automatically does stash -> operation -> stash pop when you checkout, reset or cherry pick')
